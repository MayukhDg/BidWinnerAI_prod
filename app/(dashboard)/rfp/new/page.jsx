      ...
      try {
        ...
        if (res.ok) {
          ...
          if (data.credits > 0) {
            ...
            setError(
              <span>
                You do not have enough credits to create a new RFP project. <Link href="/pricing" className="underline font-bold">Buy credits</Link>
              </span>
            );
          }
        }
  ...
  return (
    <div className="max-w-2xl mx-auto py-12 px-4">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
        {checkingCredits ? (
          <div className="text-center py-12 text-slate-500">Checking credits...</div>
        ) : (
          <>
            {error && (
            ...
            {step === 'upload' && !hasCredits && (
               <div className="text-center py-8">
                  <div className="mb-6">
                    ...
                    <h3 className="text-lg font-medium text-slate-900">Credits Required</h3>
                    <p className="text-sm text-slate-500 mt-1">You need at least 1 credit to start a new project.</p>
                  </div>
                  <Link href="/pricing" className="inline-block bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-medium transition-colors">
                    Get Credits
                  </Link>
               </div>
            )}
